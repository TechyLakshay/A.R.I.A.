...
- [x] **M3 — Wake word**: openWakeWord loop, pretrained "hey jarvis" model → wake events on WS (custom "hey aria" swap-in via ARIA_WAKE_MODEL; formal 10-min soak folded into M7)
