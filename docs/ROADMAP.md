...
- [ ] **M3 — Wake word**: openWakeWord loop, pretrained "hey jarvis" model → wake events (custom "hey aria" train free at openwakeword.com; acceptance: 10/10 wakes, 0 false in 10 min)
